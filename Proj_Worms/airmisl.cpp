...
HRESULT airmisl::init(float power, float angle, POINT stPoint, POINT mousePoint, Map* map, UI* ui, PlayerManager* pm)
{
	...
	_img = IMAGEMANAGER->findImage("WP_mis");
	_playedSoundBeforeExplode = false;
	return S_OK;
}


void airmisl::release()
{
