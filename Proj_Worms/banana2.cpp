...
HRESULT banana2::init(float power, float angle, POINT stPoint, POINT mousePoint, Map* map, UI* ui, PlayerManager* pm)
{
	...
	_img = IMAGEMANAGER->findImage("WP_ban2");
	return S_OK;
}


void banana2::release()
{
